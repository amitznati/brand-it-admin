...
const DeleteButtonWithConfirmation = (props) => {
    ...
    return (
        <Fragment>
            <Button onClick={handleClick} label={label} className={classnames('ra-delete-button', classes.deleteButton, className)}>
                <ActionDelete />
            </Button>
            <Dialog fullWidth open={showDialog} onClose={handleCloseClick} aria-label="Are you sure?">
                ...
                <DialogActions>
                    <DeleteButton label={label} className={classnames('ra-delete-button', classes.deleteButton, className)} {...props}>
                        <ActionDelete />
                    </DeleteButton>
