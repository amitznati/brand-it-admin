...
const SaveTemplateButton = (props) => {
    ...
    return (
        <Button label="Save" onClick={approve} disabled={loading || template === initialTemplate} />
    );
};
...
const EditTemplateForProduct = ({
    ...
    return (
        <SimpleForm
            toolbar={
                <PostCreateToolbar
                    template={templateInEdit}
                    {...{resetTemplateInEdit, onAddTemplate}}
                />
            }
            {...props}
        >
        ...
        <Show {...rest} title={<CustomEditTitle resource="Product" />}>
            <SimpleShowLayout>
                ...
                <EditTemplateForProduct
                    {...{templateInEdit, setTemplateInEdit, resetTemplateInEdit, onAddTemplate}}
                />
                ...
                <ProductTemplatesPreview
                    ...
                    onEditTemplate={setTemplateInEdit}
                />
            </SimpleShowLayout>
        </Show>
    );
